  ...
  return (
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
      <div class="mx-auto max-w-2xl px-4 2xl:px-0">
        <h2 class="mb-2 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Thanks for your order!</h2>
        ...
        <div class="mb-6 space-y-4 rounded-lg border border-gray-100 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800 sm:space-y-2 md:mb-8">
          ...
          <dl class="items-center justify-between gap-4 sm:flex">
            <dt class="mb-1 font-normal text-gray-500 dark:text-gray-400 sm:mb-0">Name</dt>
            <dd class="font-medium text-gray-900 dark:text-white sm:text-end">Flowbite Studios LLC</dd>
          </dl>
          <dl class="items-center justify-between gap-4 sm:flex">
            <dt class="mb-1 font-normal text-gray-500 dark:text-gray-400 sm:mb-0">Address</dt>
